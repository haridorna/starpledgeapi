...
class SearchByVisitorController extends AbstractActionController
{
    public function searchByVisitorAction()
    {
        ...
        if($reqObj->isPost()){
            ...
            if(!isset($data['location'])) $data['location'] = 'fremont';
            ...
            if(isset($yelpData['error'])) return new ApiProblemResponse(new ApiProblem(422, $yelpData['error']['text'] ));
